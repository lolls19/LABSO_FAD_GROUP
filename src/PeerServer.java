...
GestoreRichiestaPeer su un thread dedicato, passandogli anche la FifoQueue
...
public class PeerServer implements Runnable {
    ...
    */
    ...
    ognuna crea un GestoreRichiestaPeer su un thread daemon dedicato, cosi' puo' subito tornare ad
    ...
    public void run() {
        while (running) {
            try {
                ...
                Thread t = new Thread(new GestoreRichiestaPeer(client, store, serveLock));
                t.setDaemon(true);
                t.start();
            } catch (IOException e) {
